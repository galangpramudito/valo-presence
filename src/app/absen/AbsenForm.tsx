...
export default function AbsenForm({ nama, schedules = [] }: { nama: string; schedules?: Schedule[] }) {
  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit} className="animate-slide-up delay-100">
        ...
        <div className="border border-black/20 dark:border-white/20 bg-black/5 dark:bg-white/5 p-2">
